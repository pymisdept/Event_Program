...
<head runat="server">
    ...
    <script>
        ...
        function change_english() {
            ...
            $("#registerbtn").attr("href", "./Draw/?lang=eng");
        }
    ...
    <div class="row justify-content-center">
        <div class="col-xl-3 col-md-4 col-lg-4 col-sm-6 col-10" style="text-align:left">
                        <div class="pretty info curvy a-tada">
                            ...
                            <label><i class="mdi mdi-check-bold"></i><span style="color:red"> *</span><span class="checkbox_label" style="line-height: 1.4;font-weight: bold;letter-spacing:2px;text-shadow: 4px 1px 1px #f8f9fa;" data-localize="declare1">本人為合資格參與抽獎之保華員工+。</span>
                            </label>
                        </div>
        </div>
                    </div>
        ...
        <div class="col-xl-3 col-md-4 col-lg-4 col-sm-6 col-10" style="text-align:left">
            <div class="pretty info curvy a-tada">
                ...
                <label>
                    <i class="mdi mdi-check-bold"></i><span style="color:red"> *</span><span class="checkbox_label" style="line-height: 1.4;font-weight: bold;letter-spacing:2px;text-shadow: 4px 1px 1px #f8f9fa;" data-localize="declare2">本人於登記抽獎當天已完成接種兩劑新冠疫苗。</span>
                </label>
            </div>
        </div>
    </div>
    <div class="banner-button">
        <a id="registerbtn" class="registerGATrigger" onclick="return jump_to_next()" href="./Draw">
